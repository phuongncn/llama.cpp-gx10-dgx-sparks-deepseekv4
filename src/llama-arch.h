...
enum llm_tensor {
    ...
    LLM_TENSOR_V4F_ATTN_WKV,
    LLM_TENSOR_V4F_ATTN_WQ_A,
    LLM_TENSOR_V4F_ATTN_WQ_B,
    LLM_TENSOR_V4F_ATTN_WO_A,
    LLM_TENSOR_V4F_ATTN_WO_B,
    LLM_TENSOR_V4F_ATTN_Q_NORM,
    LLM_TENSOR_V4F_ATTN_KV_NORM,
    LLM_TENSOR_V4F_ATTN_SINK,
    LLM_TENSOR_V4F_FFN_GATE,
    LLM_TENSOR_V4F_FFN_DOWN,
    LLM_TENSOR_V4F_FFN_UP,
    LLM_TENSOR_V4F_FFN_GATE_SHEXP,
    LLM_TENSOR_V4F_FFN_DOWN_SHEXP,
    LLM_TENSOR_V4F_FFN_UP_SHEXP,
    LLM_TENSOR_V4F_FFN_GATE_INP,
    LLM_TENSOR_V4F_OUTPUT,
    LLM_TENSOR_V4F_OUTPUT_NORM,
};
